...
trap '' 2
echo
echo "(1) Scan das Portas de um IP (ex: 192.168.1.1)"
echo "(2) Scan das Portas de um Dominio (ex: www.globo.com)"
echo "(0) Voltar"
echo
...
echo 'echo "(1) Scan das Portas de um IP (ex: 192.168.1.1)"' >> .portscan-again.sh
echo 'echo "(2) Scan das Portas de um Dominio (ex: www.globo.com)"' >> .portscan-again.sh
